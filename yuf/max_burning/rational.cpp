...
//    Line(const Point& p1 = Point(), const Point& p2 = Point()) : p1(p1), p2(p2), visible(1) {}

    Line(const Point& p1 = Point(), const Point& p2 = Point(), const int& visible = 1) : p1(p1), p2(p2), visible(visible) {}
